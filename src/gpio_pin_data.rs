...
static JETSON_ORIN_NX: &str = "JETSON_ORIN_NX";
static JETSON_ORIN_NANO: &str = "JETSON_ORIN_NANO";
static JETSON_THOR_REFERENCE: &str = "JETSON_THOR_REFERENCE";

static JETSON_MODELS: [&str; 11] = [
    JETSON_TX1,
    JETSON_TX2,
    CLARA_AGX_XAVIER,
    JETSON_TX2_NX,
...
fn read_file_to_string(path: &str) -> String {
    match fs::read_to_string(path) {
        ...
        Err(_e) => {
            // error!("Failed to read file {}: {}", path, _e);
            String::from("")
        }
    }
}
...
fn get_model() -> Result<String> {
    ...
    let model_name = env::var("JETSON_TESTING_MODEL_NAME");
    if model_name.is_ok() {
    ...
    let compats_jetson_thor_reference = [
    ...
    if Path::new(compatible_path).exists() {
        ...
        if matches(&compats_jetson_thor_reference, &compats) {
            warn_if_not_carrier_board(&["3971", "4071"]);
            return Ok(String::from(JETSON_THOR_REFERENCE));
        } else if matches(&compats_jetson_orins_nx, &compats) {
            warn_if_not_carrier_board(&["3509", "3768"]);
            return Ok(String::from(JETSON_ORIN_NX));
        } else if matches(&compats_jetson_orins_nano, &compats) {
            warn_if_not_carrier_board(&["3509", "3768"]);
            return Ok(String::from(JETSON_ORIN_NANO));
        } else if matches(&compats_jetson_orins, &compats) {
...
fn get_pin_defs(model: &str) -> Result<Vec<PinDefinition>, anyhow::Error> {
    ...
    let jetson_orin_nx_pin_defs = [
        PinDefinition {
            gpio: HashMap::from([(164, 144)]),
            name: HashMap::from([(164, String::from("PAC.06"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 7,
            bcm: 4,
            cvm: String::from("GPIO09"),
            tegra_soc: String::from("GP167"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        ...
        PinDefinition {
            gpio: HashMap::from([(164, 122)]),
            name: HashMap::from([(164, String::from("PY.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 13,
            bcm: 27,
            cvm: String::from("SPI1_SCK"),
            tegra_soc: String::from("GP36_SPI3_CLK"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        ...
        PinDefinition {
            gpio: HashMap::from([(164, 126)]),
            name: HashMap::from([(164, String::from("PY.04"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 16,
            bcm: 23,
            cvm: String::from("SPI1_CS1"),
            tegra_soc: String::from("GP40_SPI3_CS1_N"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(164, 125)]),
            name: HashMap::from([(164, String::from("PY.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 18,
            bcm: 24,
            cvm: String::from("SPI1_CS0"),
            tegra_soc: String::from("GP39_SPI3_CS0_N"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        ...
        PinDefinition {
            gpio: HashMap::from([(164, 123)]),
            name: HashMap::from([(164, String::from("PY.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 22,
            bcm: 25,
            cvm: String::from("SPI1_MISO"),
            tegra_soc: String::from("GP37_SPI3_MISO"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        ...
        PinDefinition {
            gpio: HashMap::from([(164, 105)]),
            name: HashMap::from([(164, String::from("PQ.05"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 29,
            bcm: 5,
            cvm: String::from("GPIO01"),
            tegra_soc: String::from("GP65"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        ...
        PinDefinition {
            gpio: HashMap::from([(164, 41)]),
            name: HashMap::from([(164, String::from("PG.06"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 32,
            bcm: 12,
            cvm: String::from("GPIO07"),
            tegra_soc: String::from("GP113_PWM7"),
            pwm_chip_sysfs: Some(String::from("32e0000.pwm")),
            pwm_id: Some(0),
            reg_addr: None,
        },
        PinDefinition {
        ...
        PinDefinition {
            gpio: HashMap::from([(164, 124)]),
            name: HashMap::from([(164, String::from("PY.02"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 37,
            bcm: 26,
            cvm: String::from("SPI1_MOSI"),
            tegra_soc: String::from("GP38_SPI3_MOSI"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
    ...
    let clara_agx_xavier_pin_defs = [
        ...
        PinDefinition {
            ...
            bcm: 18,
            cvm: String::from("I2S2_CLK"),
            tegra_soc: String::from("DAP2_SCLK"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            ...
            board: 13,
            bcm: 27,
            cvm: String::from("GPIO32"),
            tegra_soc: String::from("SOC_GPIO04"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(164, 84)]),
            name: HashMap::from([(164, String::from("PN.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 15,
            bcm: 22,
        ...
        PinDefinition {
            ...
            board: 16,
            bcm: 23,
            cvm: String::from("GPIO8"),
            tegra_soc: String::from("CAN1_STB"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(164, 44)]),
            name: HashMap::from([(164, String::from("PH.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 18,
            bcm: 24,
            cvm: String::from("GPIO35"),
            tegra_soc: String::from("SOC_GPIO12"),
            pwm_chip_sysfs: Some(String::from("32c0000.pwm")),
            pwm_id: Some(0),
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(164, 162)]),
            name: HashMap::from([(164, String::from("PZ.05"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 19,
            bcm: 10,
        ...
        PinDefinition {
            gpio: HashMap::from([(164, 101)]),
            name: HashMap::from([(164, String::from("PQ.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 22,
            bcm: 25,
            cvm: String::from("GPIO17"),
            tegra_soc: String::from("SOC_GPIO21"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(164, 160)]),
            name: HashMap::from([(164, String::from("PZ.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 23,
            bcm: 11,
        ...
        PinDefinition {
            ...
            bcm: 5,
            cvm: String::from("CAN0_DIN"),
            tegra_soc: String::from("CAN0_DIN"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            ...
            bcm: 6,
            cvm: String::from("CAN0_DOUT"),
            tegra_soc: String::from("CAN0_DOUT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        ...
        PinDefinition {
            ...
            bcm: 13,
            cvm: String::from("CAN1_DOUT"),
            tegra_soc: String::from("CAN1_DOUT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(164, 54)]),
            name: HashMap::from([(164, String::from("PI.02"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 35,
            bcm: 19,
            cvm: String::from("I2S2_FS"),
            tegra_soc: String::from("DAP2_FS"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        ...
        PinDefinition {
            ...
            bcm: 26,
            cvm: String::from("CAN1_DIN"),
            tegra_soc: String::from("CAN1_DIN"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            ...
            bcm: 20,
            cvm: String::from("I2S2_DIN"),
            tegra_soc: String::from("DAP2_DIN"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            ...
            bcm: 21,
            cvm: String::from("I2S2_DOUT"),
            tegra_soc: String::from("DAP2_DOUT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
    ...
    let jetson_xavier_pin_defs = [
        PinDefinition {
            gpio: HashMap::from([(224, 106), (169, 118)]),
            name: HashMap::from([(169, String::from("PQ.06"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 7,
            bcm: 4,
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 51), (169, 54)]),
            name: HashMap::from([(169, String::from("PH.07"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 12,
            bcm: 18,
            cvm: String::from("I2S2_CLK"),
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 108), (169, 79)]),
            name: HashMap::from([(169, String::from("PR.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 13,
            bcm: 27,
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 84), (169, 74)]),
            name: HashMap::from([(169, String::from("PN.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 15,
            bcm: 22,
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 44), (169, 41)]),
            name: HashMap::from([(169, String::from("PH.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 18,
            bcm: 24,
            cvm: String::from("GPIO35"),
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 162), (169, 130)]),
            name: HashMap::from([(169, String::from("PZ.05"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 19,
            bcm: 10,
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 161), (169, 129)]),
            name: HashMap::from([(169, String::from("PZ.04"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 21,
            bcm: 9,
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 101), (169, 82)]),
            name: HashMap::from([(169, String::from("PQ.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 22,
            bcm: 25,
            cvm: String::from("GPIO17"),
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 160), (169, 128)]),
            name: HashMap::from([(169, String::from("PZ.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 23,
            bcm: 11,
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 163), (169, 131)]),
            name: HashMap::from([(169, String::from("PZ.06"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 24,
            bcm: 8,
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 164), (169, 132)]),
            name: HashMap::from([(169, String::from("PZ.07"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 26,
            bcm: 7,
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 54), (169, 50)]),
            name: HashMap::from([(169, String::from("PI.02"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 35,
            bcm: 19,
            cvm: String::from("I2S2_FS"),
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 113), (169, 92)]),
            name: HashMap::from([(169, String::from("PR.05"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 36,
            bcm: 16,
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 53), (169, 49)]),
            name: HashMap::from([(169, String::from("PI.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 38,
            bcm: 20,
            cvm: String::from("I2S2_DIN"),
        ...
        PinDefinition {
            gpio: HashMap::from([(224, 52), (169, 48)]),
            name: HashMap::from([(169, String::from("PI.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 40,
            bcm: 21,
            cvm: String::from("I2S2_DOUT"),
    ...
    let jetson_tx2_nx_pin_defs = [
        PinDefinition {
            gpio: HashMap::from([(26, 76)]),
            name: HashMap::from([(26, String::from("PJ.04"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 7,
            bcm: 4,
            cvm: String::from("GPIO09"),
        ...
        PinDefinition {
            gpio: HashMap::from([(11, 28)]),
            name: HashMap::from([(11, String::from("PW.04"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 11,
            bcm: 17,
            cvm: String::from("UART1_RTS"),
            tegra_soc: String::from("UART3_RTS"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 72)]),
            name: HashMap::from([(26, String::from("PJ.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 12,
            bcm: 18,
            cvm: String::from("I2S0_SCLK"),
            tegra_soc: String::from("DAP1_SCLK"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 17)]),
            name: HashMap::from([(11, String::from("PV.01"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 13,
            bcm: 27,
            cvm: String::from("SPI1_SCK"),
            tegra_soc: String::from("GPIO_SEN1"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 18)]),
            name: HashMap::from([(26, String::from("PC.02"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 15,
            bcm: 22,
            cvm: String::from("GPIO12"),
        ...
        PinDefinition {
            gpio: HashMap::from([(26, 19)]),
            name: HashMap::from([(26, String::from("PC.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 16,
            bcm: 23,
            cvm: String::from("SPI1_CS1"),
        ...
        PinDefinition {
            gpio: HashMap::from([(11, 20)]),
            name: HashMap::from([(11, String::from("PV.04"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 18,
            bcm: 24,
            cvm: String::from("SPI1_CS0"),
            tegra_soc: String::from("GPIO_SEN4"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 58)]),
            name: HashMap::from([(26, String::from("PH.02"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 19,
            bcm: 10,
            cvm: String::from("SPI0_MOSI"),
            tegra_soc: String::from("GPIO_WAN7"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 57)]),
            name: HashMap::from([(26, String::from("PH.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 21,
            bcm: 9,
            cvm: String::from("SPI0_MISO"),
            tegra_soc: String::from("GPIO_WAN6"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 18)]),
            name: HashMap::from([(11, String::from("PV.02"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 22,
            bcm: 25,
            cvm: String::from("SPI1_MISO"),
            tegra_soc: String::from("GPIO_SEN2"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 56)]),
            name: HashMap::from([(26, String::from("PH.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 23,
            bcm: 11,
            cvm: String::from("SPI1_CLK"),
            tegra_soc: String::from("GPIO_WAN5"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 59)]),
            name: HashMap::from([(26, String::from("PH.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 24,
            bcm: 8,
            cvm: String::from("SPI0_CS0"),
            tegra_soc: String::from("GPIO_WAN8"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 163)]),
            name: HashMap::from([(26, String::from("PY.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 26,
            bcm: 7,
            cvm: String::from("SPI0_CS1"),
            tegra_soc: String::from("GPIO_MDM4"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 105)]),
            name: HashMap::from([(26, String::from("PN.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 29,
            bcm: 5,
            cvm: String::from("GPIO01"),
            tegra_soc: String::from("GPIO_CAM2"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 50)]),
            name: HashMap::from([(11, String::from("PEE.02"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 31,
            bcm: 6,
            cvm: String::from("GPIO11"),
        ...
        PinDefinition {
            gpio: HashMap::from([(11, 8)]),
            name: HashMap::from([(11, String::from("PU.00"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 32,
            bcm: 12,
            cvm: String::from("GPIO07"),
            tegra_soc: String::from("GPIO_DIS0"),
            pwm_chip_sysfs: Some(String::from("3280000.pwm")),
            pwm_id: Some(0),
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 13)]),
            name: HashMap::from([(11, String::from("PU.05"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 33,
            bcm: 13,
            cvm: String::from("GPIO13"),
            tegra_soc: String::from("GPIO_DIS5"),
            pwm_chip_sysfs: Some(String::from("32a0000.pwm")),
            pwm_id: Some(0),
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 75)]),
            name: HashMap::from([(26, String::from("PJ.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 35,
            bcm: 19,
            cvm: String::from("I2S0_FS"),
            tegra_soc: String::from("DAP1_FS"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 29)]),
            name: HashMap::from([(11, String::from("PW.05"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 36,
            bcm: 16,
            cvm: String::from("UART1_CTS"),
            tegra_soc: String::from("UART3_CTS"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 19)]),
            name: HashMap::from([(11, String::from("PV.03"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 37,
            bcm: 26,
            cvm: String::from("SPI1_MOSI"),
            tegra_soc: String::from("GPIO_SEN3"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 74)]),
            name: HashMap::from([(26, String::from("PJ.02"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 38,
            bcm: 20,
            cvm: String::from("I2S0_DIN"),
            tegra_soc: String::from("DAP1_DIN"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 73)]),
            name: HashMap::from([(26, String::from("PJ.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 40,
            bcm: 21,
            cvm: String::from("I2S0_DOUT"),
            tegra_soc: String::from("DAP1_DOUT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
    ...
    let jetson_tx2_pin_defs = [
        ...
        PinDefinition {
            gpio: HashMap::from([(26, 146)]),
            name: HashMap::from([(26, String::from("PT.02"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 11,
            bcm: 17,
            cvm: String::from("PUART0_RTS"),
            tegra_soc: String::from("UART1_RTS"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        ...
        PinDefinition {
            gpio: HashMap::from([(26, 77)]),
            name: HashMap::from([(26, String::from("PJ.05"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 13,
            bcm: 27,
            cvm: String::from("PGPIO20_AUD_INT"),
            tegra_soc: String::from("GPIO_AUD0"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 15)]),
            name: HashMap::from([(26, String::from("GPIO_EXP_P16"))]),
            chip_sysfs: String::from("tca9539"),
            board: 15,
            bcm: 22,
            cvm: String::from("GPIO_EXP_P17"),
            tegra_soc: String::from("GPIO_EXP_P17"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 40)]),
            name: HashMap::from([(11, String::from("PAA.00"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 16,
            bcm: 23,
            cvm: String::from("AO_DMIC_IN_DAT"),
            tegra_soc: String::from("CAN_GPIO0"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 161)]),
            name: HashMap::from([(26, String::from("PY.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 18,
            bcm: 24,
            cvm: String::from("GPIO16_MDM_WAKE_AP"),
            tegra_soc: String::from("GPIO_MDM2"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 109)]),
            name: HashMap::from([(26, String::from("PN.05"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 19,
            bcm: 10,
            cvm: String::from("SPI1_MOSI"),
            tegra_soc: String::from("GPIO_CAM6"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 108)]),
            name: HashMap::from([(26, String::from("PN.04"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 21,
            bcm: 9,
            cvm: String::from("SPI1_MISO"),
            tegra_soc: String::from("GPIO_CAM5"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 14)]),
            name: HashMap::from([(26, String::from("GPIO_EXP_P16"))]),
            chip_sysfs: String::from("tca9539"),
            board: 22,
            bcm: 25,
            cvm: String::from("GPIO_EXP_P16"),
            tegra_soc: String::from("GPIO_EXP_P16"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 107)]),
            name: HashMap::from([(26, String::from("PN.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 23,
            bcm: 11,
            cvm: String::from("SPI1_CLK"),
            tegra_soc: String::from("GPIO_CAM4"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 110)]),
            name: HashMap::from([(26, String::from("PN.06"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 24,
            bcm: 8,
            cvm: String::from("SPI1_CS0"),
            tegra_soc: String::from("GPIO_CAM7"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 78)]),
            name: HashMap::from([(26, String::from("PJ.06"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 29,
            bcm: 5,
            cvm: String::from("GPIO19_AUD_RST"),
            tegra_soc: String::from("GPIO_AUD1"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 42)]),
            name: HashMap::from([(11, String::from("PAA.02"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 31,
            bcm: 6,
            cvm: String::from("GPIO9_MOTION_INT"),
            tegra_soc: String::from("CAN_GPIO2"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 41)]),
            name: HashMap::from([(11, String::from("PAA.01"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 32,
            bcm: 12,
            cvm: String::from("AO_DMIC_IN_CLK"),
            tegra_soc: String::from("CAN_GPIO1"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(26, 69)]),
            name: HashMap::from([(26, String::from("PI.05"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 33,
            bcm: 13,
            cvm: String::from("GPIO11_AP_WAKE_BT"),
            tegra_soc: String::from("GPIO_PQ5"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        ...
        PinDefinition {
            gpio: HashMap::from([(26, 147)]),
            name: HashMap::from([(26, String::from("PT.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 36,
            bcm: 16,
            cvm: String::from("UART0_CTS"),
            tegra_soc: String::from("UART1_CTS"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        ...
        PinDefinition {
            gpio: HashMap::from([(26, 68)]),
            name: HashMap::from([(26, String::from("PI.04"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 37,
            bcm: 26,
            cvm: String::from("GPIO8_ALS_PROX_INT"),
            tegra_soc: String::from("GPIO_PQ4"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
    ...
    let jetson_tx1_pin_defs = [
        PinDefinition {
            gpio: HashMap::from([(16, 216)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 7,
            bcm: 4,
            cvm: String::from("AUDIO_MCLK"),
            tegra_soc: String::from("AUD_MCLK"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        ...
        PinDefinition {
            gpio: HashMap::from([(16, 162)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 11,
            bcm: 17,
            cvm: String::from("UART0_RTS"),
            tegra_soc: String::from("UART1_RTS"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        ...
        PinDefinition {
            gpio: HashMap::from([(16, 11)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 12,
            bcm: 18,
            cvm: String::from("I2S0_CLK"),
            tegra_soc: String::from("DAP1_SCLK"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        ...
        PinDefinition {
            gpio: HashMap::from([(16, 38)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 13,
            bcm: 27,
            cvm: String::from("GPIO20_AUD_INT"),
        ...
        PinDefinition {
            gpio: HashMap::from([(16, 37)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 16,
            bcm: 23,
            cvm: String::from("AO_DMIC_IN_DAT"),
            tegra_soc: String::from("DMIC3_DAT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 184)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 18,
            bcm: 24,
            cvm: String::from("GPIO16_MDM_WAKE_AP"),
            tegra_soc: String::from("MODEM_WAKE_AP"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        ...
        PinDefinition {
            gpio: HashMap::from([(16, 219)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 29,
            bcm: 5,
            cvm: String::from("GPIO19_AUD_RST"),
            tegra_soc: String::from("GPIO_X1_AUD"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 186)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 31,
            bcm: 6,
            cvm: String::from("GPIO9_MOTION_INT"),
            tegra_soc: String::from("MOTION_INT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 36)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 32,
            bcm: 12,
            cvm: String::from("AO_DMIC_IN_CLK"),
            tegra_soc: String::from("DMIC3_CLK"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 63)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 33,
            bcm: 13,
            cvm: String::from("GPIO11_AP_WAKE_BT"),
            tegra_soc: String::from("AP_WAKE_NFC"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 8)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 35,
            bcm: 19,
        ...
        PinDefinition {
            gpio: HashMap::from([(16, 187)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 37,
            bcm: 26,
            cvm: String::from("GPIO8_ALS_PROX_INT"),
            tegra_soc: String::from("ALS_PROX_INT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 9)]),
            name: HashMap::from([(16, String::from(""))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 38,
            bcm: 20,
    ...
    let jetson_thor_reference_pin_defs = [
        PinDefinition {
            gpio: HashMap::from([(16, 86)]),
            name: HashMap::from([(16, String::from("PL.06"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 7,
            bcm: 4,
            cvm: String::from("MCLK05"),
            tegra_soc: String::from("GP130"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 92)]),
            name: HashMap::from([(16, String::from("PM.04"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 11,
            bcm: 17,
            cvm: String::from("UART1_RTS"),
            tegra_soc: String::from("GP136_UART9_RTS_N"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 21)]),
            name: HashMap::from([(16, String::from("PV.06"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 12,
            bcm: 18,
            cvm: String::from("I2S2_CLK"),
            tegra_soc: String::from("GP184_DAP2_CLK"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 88)]),
            name: HashMap::from([(16, String::from("PM.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 13,
            bcm: 27,
            cvm: String::from("PWM01"),
            tegra_soc: String::from("GP132_PWM9"),
            pwm_chip_sysfs: Some(String::from("810c610000.pwm")),
            pwm_id: Some(0),
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 127)]),
            name: HashMap::from([(16, String::from("PF.07"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 15,
            bcm: 22,
            cvm: String::from("GPIO27"),
            tegra_soc: String::from("GP257_PWM2"),
            pwm_chip_sysfs: Some(String::from("810c5e0000.pwm")),
            pwm_id: Some(0),
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 21)]),
            name: HashMap::from([(11, String::from("PDD.03"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 16,
            bcm: 23,
            cvm: String::from("GPIO08"),
            tegra_soc: String::from("GP21"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 14)]),
            name: HashMap::from([(16, String::from("PU.07"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 18,
            bcm: 24,
            cvm: String::from("GPIO44"),
            tegra_soc: String::from("GP177_PWM5"),
            pwm_chip_sysfs: Some(String::from("810c600000.pwm")),
            pwm_id: Some(0),
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 73)]),
            name: HashMap::from([(16, String::from("PK.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 19,
            bcm: 10,
            cvm: String::from("SPI1_MOSI"),
            tegra_soc: String::from("GP117_SPI1_MOSI"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 72)]),
            name: HashMap::from([(16, String::from("PK.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 21,
            bcm: 9,
            cvm: String::from("SPI1_MISO"),
            tegra_soc: String::from("GP116_SPI1_MISO"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 7)]),
            name: HashMap::from([(16, String::from("PU.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 22,
            bcm: 25,
            cvm: String::from("I2S7_DIN"),
            tegra_soc: String::from("GP170"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 71)]),
            name: HashMap::from([(16, String::from("PJ.07"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 23,
            bcm: 11,
            cvm: String::from("SPI1_CLK"),
            tegra_soc: String::from("GP115_SPI1_CLK"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 74)]),
            name: HashMap::from([(16, String::from("PK.02"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 24,
            bcm: 8,
            cvm: String::from("SPI1_CS0_N"),
            tegra_soc: String::from("GP118_SPI1_CS0_N"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 75)]),
            name: HashMap::from([(16, String::from("PK.03"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 26,
            bcm: 7,
            cvm: String::from("SPI1_CS1_N"),
            tegra_soc: String::from("GP119_SPI1_CS1_N"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 1)]),
            name: HashMap::from([(11, String::from("PAD.01"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 29,
            bcm: 5,
            cvm: String::from("CAN2_DIN"),
            tegra_soc: String::from("GP211_CAN2_DIN"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 0)]),
            name: HashMap::from([(11, String::from("PAD.00"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 31,
            bcm: 6,
            cvm: String::from("CAN2_DOUT"),
            tegra_soc: String::from("GP210_CAN2_DOUT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 22)]),
            name: HashMap::from([(11, String::from("PDD.04"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 32,
            bcm: 12,
            cvm: String::from("GPIO09"),
            tegra_soc: String::from("GGP22_SOCKET_ID_STRA"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 2)]),
            name: HashMap::from([(11, String::from("PAE.00"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 33,
            bcm: 13,
            cvm: String::from("CAN3_DOUT"),
            tegra_soc: String::from("GP215_CAN3_DOUT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 24)]),
            name: HashMap::from([(16, String::from("PW.01"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 35,
            bcm: 19,
            cvm: String::from("I2S2_FS"),
            tegra_soc: String::from("GP187_DAP2_FS"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 93)]),
            name: HashMap::from([(16, String::from("PM.05"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 36,
            bcm: 16,
            cvm: String::from("UART1_CTS"),
            tegra_soc: String::from("GP137_UART9_CTS_N"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(11, 3)]),
            name: HashMap::from([(11, String::from("PAE.01"))]),
            chip_sysfs: String::from("c2f0000.gpio"),
            board: 37,
            bcm: 26,
            cvm: String::from("CAN3_DIN"),
            tegra_soc: String::from("GP216_CAN3_DIN"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 23)]),
            name: HashMap::from([(16, String::from("PW.00"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 38,
            bcm: 20,
            cvm: String::from("I2S2_DIN"),
            tegra_soc: String::from("GP186_DAP2_DIN"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
        PinDefinition {
            gpio: HashMap::from([(16, 22)]),
            name: HashMap::from([(16, String::from("PV.07"))]),
            chip_sysfs: String::from("2200000.gpio"),
            board: 40,
            bcm: 21,
            cvm: String::from("I2S2_DOUT"),
            tegra_soc: String::from("GP185_DAP2_DOUT"),
            pwm_chip_sysfs: None,
            pwm_id: None,
            reg_addr: None,
        },
    ...
    if model == JETSON_ORIN {
        ...
        return Ok(pin_defs);
    } else if model == JETSON_ORIN_NX {
        let pin_defs = jetson_orin_nx_pin_defs.to_vec();
        return Ok(pin_defs);
    } else if model == JETSON_ORIN_NANO {
        let pin_defs = jetson_orin_nx_pin_defs.to_vec();
        return Ok(pin_defs);
    } else if model == JETSON_THOR_REFERENCE {
        let pin_defs = jetson_thor_reference_pin_defs.to_vec();
        return Ok(pin_defs);
    }
...
fn get_jetson_info(model: &str) -> Result<JetsonInfo, anyhow::Error> {
    if model == JETSON_ORIN {
        ...
        let jetson_info = JetsonInfo {
            ...
            ram: String::from("32768M, 65536M"),
            revision: String::from("Unknown"),
            ttype: String::from("JETSON_ORIN_NX"),
            manufacturer: String::from("NVIDIA"),
            processor: String::from("A78AE"),
        };
        return Ok(jetson_info);
        ...
        let jetson_info = JetsonInfo {
            ...
            ram: String::from("32768M, 65536M"),
            revision: String::from("Unknown"),
            ttype: String::from("JETSON_ORIN_NANO"),
            manufacturer: String::from("NVIDIA"),
            processor: String::from("A78AE"),
        };
        return Ok(jetson_info);
        ...
        let jetson_info = JetsonInfo {
            ...
            ram: String::from("4096M, 2048M"),
            revision: String::from("Unknown"),
            ttype: String::from("Jetson THOR REFERENCE"),
            manufacturer: String::from("NVIDIA"),
            processor: String::from("ARM A57"),
        };
        return Ok(jetson_info);
